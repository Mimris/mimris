...
Legacy material in `docs/_specs/` remains valuable as reference, but new active feature work belongs in GitHub Spec Kit.
...
- Single source of truth for active specs
  - New active feature specs belong in `.specify/specs/`, not `docs/_specs/`.
