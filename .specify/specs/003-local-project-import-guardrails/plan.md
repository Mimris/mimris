...
## Summary
Harden local project import so valid files replace prior session state cleanly, empty model files fail with an explicit message, and repeated imports from the project menu remain reliable.
