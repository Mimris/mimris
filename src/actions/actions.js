...
export const loadDataSuccess = (data) => {
  // if (debug) console.log('37 --loadDataSuccess ', data);
  return {
...
export const loadToStoreData = (data) => {
  // if (debug) console.log('21---actions | setFocusPhdata ', data);
  return {
...
export const loadToStorePhfocus = (data) => {
  if (debug) console.log('21---actions | setFocusPhfocus ', data);
  return {
...
export const loadToStorePhsource = (data) => {
  // if (debug) console.log('46---actions |setFocusPhsource ', data);
  return {
...
export const loadToStoreNewModel = (data) => {
  // if (debug) console.log('21---actions | loadToStoreNewModel ', data);
  return {
...
export const loadToStoreNewModelview = (data) => {
  // if (debug) console.log('21---actions | loadToStoreNewModelview ', data);
  return {
...
export const setFocusModelview = (data) => {
  // if (debug) console.log('21---', data.value);
  return {
...
export const setMymetisModel = (data) => {
  if (debug) console.log('103---myMetis', data);
  return {
...
export const setMyMetisParameter = (data) => {
  if (debug) console.log('110---MyMetisParameter', data);
  return {
...
export const setMyGoModel = (data) => {
  if (debug) console.log('21---myMetis', data);
  return {
    type: SET_MY_GOMODEL,
    data: JSON.parse(data.value)
  }
...
export const setFocusTask = (data) => {
  // if (debug) console.log('action-Task-data', data.value);
  // if (debug) console.log('action-Task-data', JSON.parse(data.value));
  return {
    type: SET_FOCUS_TASK,
    data: JSON.parse(data.value)
  }
...
export const setFocusIssue = (data) => {
  // if (debug) console.log('action-type-data', data);
  return {
...
export const update_project_properties = (data) => {
  // if (debug) console.log('76 actions update_model_properties', data.payload);
  return {
...
export const update_modelview_properties = (data) => {
  // if (debug) console.log('76 actions update_modelview_properties', data.payload);
  return {
...
export const update_metamodel_properties = (data) => {
  // if (debug) console.log('76 actions update_metamodel_properties', data.payload);
  return {
...
export const update_objectview_properties = (data) => {
  // if (debug) console.log('269 actions update_objectview_properties', data.payload);
  return {
...
export const update_relshipview_properties = (data) => {
  // if (debug) console.log('76 actions update_relshipview_properties', data.payload);
  return {
...
export const update_objecttype_properties = (data) => {
  // if (debug) console.log('205 actions update_objecttype_properties', data.payload);
  return {
...
export const update_targetmodel_properties = (data) => {
  // if (debug) console.log('205 actions update_targetmodel_properties', data.payload);
  return {
...
export const update_targetobjecttype_properties = (data) => {
  if (debug) console.log('205 actions update_targetobjecttype_properties', data.payload);
  return {
...
export const update_objecttypeview_properties = (data) => {
  if (debug) console.log('205 actions update_objecttypeview_properties', data.payload);
  return {
...
export const update_objecttypegeos_properties = (data) => {
  if (debug) console.log('205 actions update_objecttypegeos_properties', data.payload);
  return {
...
export const update_property_properties = (data) => {
  if (debug) console.log('205 actions update_property_properties', data.payload);
  return {
...
export const update_targetmetamodel_properties = (data) => {
  if (debug) console.log('345 actions update_targetmetamodel_properties', data.payload);
  return {
...
export const update_targetobjecttypegeos_properties = (data) => {
  if (debug) console.log('205 actions update_targetobjecttypegeos_properties', data.payload);
  return {
...
export const update_targetrelshiptype_properties = (data) => {
  if (debug) console.log('205 actions update_targetrelshiptype_properties', data.payload);
  return {
...
export const update_targetrelshiptypeview_properties = (data) => {
  if (debug) console.log('205 actions update_targetrelshiptypeview_propertie', data.payload);
  return {
...
export const update_targetproperty_properties = (data) => {
  if (debug) console.log('205 actions update_targetproperty_properties', data.payload);
  return {
...
export const update_targetvalue_properties = (data) => {
  if (debug) console.log('205 actions update_targetvalue_properties', data.payload);
  return {
...
export const update_datatype_properties = (data) => {
  if (debug) console.log('311 actions update_datatype_properties', data.payload);
  return {
...
export const update_value_properties = (data) => {
  if (debug) console.log('205 actions update_value_properties', data.payload);
  return {
...
export const update_relshiptype_properties = (data) => {
  if (debug) console.log('205 actions update_relshiptype_properties', data.payload);
  return {
...
export const update_relshiptypeviews_properties = (data) => {
  if (debug) console.log('205 actions update_relshiptypeviews_properties', data.payload);
  return {
...
export const update_object_properties = (data) => {
  if (debug) console.log('205 actions update_object_properties', data.payload);
  return {
...
export const update_relship_properties = (data) => {
  if (debug) console.log('205 actions update_relship_properties', data.payload);
  return {
...
export const update_objectview_name = (data) => {
  // if (debug) console.log('76 action-object-edit-data', data.payload);
  return {
