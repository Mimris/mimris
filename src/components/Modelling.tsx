          ...
          <div className="workpad p-1 pt-2 bg-white" >
            <Row >
              <Col xs="auto ml-3 mr-0 pr-0 pl-0">
                <div className="myPalette pl-1 mb-1 pt-2 text-white" style={{ maxWidth: "160px", minHeight: "8vh", height: "100%", marginRight: "2px", backgroundColor: "#999", border: "solid 1px black" }}>
