...
function Tasks(props) {
  ...
  const genTasksDiv = () => {
    const modview = mothermodelviews?.map((mv: any, index: number) => { // map over all modelviews of this model
      ...
      if (!debug) console.log('355 buildTree', ovsTree, topObjviews, parent);
