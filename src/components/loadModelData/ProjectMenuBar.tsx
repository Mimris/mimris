...
export const ProjectMenuBar = (props: any) => {
    ...
    const exportsonfile = <LoadJsonFile buttonLabel='OSDU Ex' className='ContextModal' ph={props} refresh={props.toggleRefresh} setRefresh={props.toggleRefresh} />
                                                ...
                                                : item === 'Import'
                                                    ...
                                                    >
                                                        <summary className="bg-light my-1 me-1 ps-1 text-black">OSDU Import/Export</summary>
                                                            ...
                                                            <div className=""><i className="fa fa-folder fa-lg mx-1 mt-3"></i>{exportjsonfile}</div>
                                                    </details>
                                                    </>
                                                    : item === 'Export'
                            }
