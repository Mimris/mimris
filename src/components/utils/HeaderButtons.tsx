...
export default function HeaderButtons(props) {
    ...
    return (
        <div className="" style={{  marginLeft: "auto", backgroundColor: "#ddd"}}>
            <div className="header-buttons" style={{  transform: "scale(0.8)", transformOrigin: "center",  backgroundColor: "#ddd" }}>

                <div className="buttonrow mr-4 d-flex justify-content-between" style={{ width: "66rem", maxHeight: "9px", minHeight: "30px" }}> 
