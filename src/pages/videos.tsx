            ...
            {/* <div className="workplace" > */}
              ...
              <div className="homepage-video d-flex align-items-start justify-content-between">
                <div className="card-body card-video-body bg-light p-2">
                  <h5 className="card-title">OSDU</h5>
                  <p className="card-text">Demos</p>
                  <div className="card-text m-2">
                    <a  href="https://app.guidde.com/share/playbooks/dJwLk6Z6B48zfxyYjDrk2E?origin=6lqYHLd8QJXDE2ZJA8TtSnurix83" className="btn btn-sm bg-link p-1 w-100" target="_blank">OSDU Import Demo</a>
                 </div>
                <p className="card-text">Instruction videos:</p>
                <div className="card-text m-2">
                    <a href="https://app.guidde.com/share/playbooks/vPvzrv5199xdPFmRoUptNb?origin=6lqYHLd8QJXDE2ZJA8TtSnurix83" className="btn btn-primary p-1 w-100" target="_blank">How to import OSDU Schematypes into AKM Modeller</a>
                  </div>
                </div>
                <div className="card-body card-video-body bg-light p-2 ">
                  <h5 className="card-title">Concept modelling</h5>
                  <p className="card-text">Concept model using IRTV metamodel</p>
                  <div className="card-text m-2">
                    {/* <a href="" className="btn btn-primary p-1 w-100" target="_blank">Building a concept model from scratch using IRTV metamodel</a> */}
                  </div>
                </div>
                <div className="card-body card-video-body bg-light p-2 ">
