---
title: ' OSDU 3: ----- Demo usecase: Building a Concept model'
date: 'May 31, 2024'
...
### To start a new project, do the following:
    ...
    - Click “LIST MODEL TEMPLATES” to get a list of templates from GitHub

    - Select “AKM-OSDU-Schemamodelling-Template_PR.json”  
    (A dialog to edit the Project name and GitHub settings will appear)

    - Give your project a new name and add you GitHub data

    - Click “Save GitHub settings” to save your changes

    - Then Click “Save to local file” you save your project-file to your local filesystem
...
### Drag in two Information-objects and name them WellLog and Wellbore

### Drag in three more “Information objects” and name them WellAcquisition, LogRun and LogPass

### Create relationships of type “refersTo” between them
