...
function reducer(state = InitialState, action) {
  ...
  switch (action.type) {
              ...
              models: [
                ...state.phData.metis.models.slice(0,curmindex2),
                {
                  ...
                  modelviews: [
                    ...
                    ...curmmv2?.modelviews?.slice(curmvindex2 + 1, curmmv2?.modelviews.length),
                  ]
                },
    ...
    case UPDATE_METAMODEL_PROPERTIES:
      // if (debug) console.log('766 UPDATE_METAMODEL_PROPERTIES', action);
    ...
    case UPDATE_TARGETMETAMODEL_PROPERTIES:
      // if (debug) console.log('567 UPDATE_TARGEMETAMODEL_PROPERTIES', action);
      ...
      // if (debug) console.log('775 curmm_tmm', curmm_tmm, curmmindex_tmm)
      return {
        ...state,
        phData: {
          ...state.phData,
              ...
              metamodels: [
                ...state.phData.metis.metamodels.slice(0, curmmindextot),
                {
                  ...
                  objecttypes: [
                    ...
                    ...curmmtot?.objecttypes.slice(indexot + 1, curmmtot?.objecttypes.length)
                  ]
                },
              ...
              metamodels: [
                ...state.phData.metis.metamodels.slice(0, curmmindextotv),
                {
                  ...
                  objecttypeviews: [
                    ...
                    ...curmmtotv?.objecttypeviews.slice(indexotv + 1, curmmtotv?.objecttypeviews.length)
                  ]
                },
            ...
            metamodels: [
              ...state.phData.metis.metamodels.slice(0, curmmindextrt),
              {
                ...
                relshiptypes: [
                  ...
                  ...curmmtrt?.relshiptypes?.slice(indexrt + 1, curmmtrt?.relshiptypes.length)
                ]
              },
        ...
        phData: {
          ...state.phData,
            ...
            metamodels: [
              ...
              ...state.phData.metis.metamodels.slice(curmmdtdindexot + 1, state.phData.metis.metamodels.length),
            ]
          },
        },
      }
            ...
            metamodels: [
              ...state.phData.metis.metamodels.slice(0, curmmindexrtv),
              {
                ...
                relshiptypeviews: [
                  ...
                  ...curmmrtv?.relshiptypeviews.slice(indexrtv + 1, curmmrtv?.relshiptypeviews.length)
                ]
              },
