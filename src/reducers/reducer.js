...
export const InitialState = {
  ...
  phFocus:  {
    ...
    {
      nodeDataArray: [
        { key: 0, text: 'Dummy StartObject 1', color: 'lightblue', loc: '0 0' },
        { key: 1, text: 'Dummy StartObject 2', color: 'lightgreen', loc: '0 -50' },
      ],
      linkDataArray: [
        { key: -1, from: 0, to: 1 },
      ],
    ...
    gojsMetamodel: {
      nodeDataArray: [
        { key: 0, text: 'Dummy Type 1', color: 'orange', loc: '0 0' },
        { key: 1, text: 'Dummy Type 2', color: 'red', loc: '0 -80' },
      ],
      linkDataArray: [],
    },
    focusModel: {
...
function reducer(state = InitialState, action) {
  switch (action.type) {
    ...
    case SET_FOCUS_OBJECT:
      ...
      focusSource = (action.data.focusObject && action.data.focusObject.focusSource) ? {focusSource : {
